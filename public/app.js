...
const tariffs = [
  {
    ...
    price:399,
    badge:'Старт',
    desc:'Для обычного человека: связь, банк, карта, оплата, повседневные сбои.',
  ...
  },
  {
    ...
    badge:'Популярно',
    popular:true,
    desc:'Для родителей, детей и родственников: простые инструкции, кодовая фраза, антискам.',
  ...
  },
  {
    ...
    price:1490,
    badge:'Работа',
    desc:'Чтобы не потерять смену, маршрут, клиента и деньги при сбоях.',
  ...
  },
  {
    ...
    price:4990,
    badge:'Доход',
    desc:'Для точки, мастера, ПВЗ, салона, магазина или сервиса.',
...
const faqs = [
  {
    ...
    a:'Клиент получает TXT-документ по своему тарифу: с чек-листами, сценариями, шаблонами сообщений, антискамом и готовыми инструкциями. Файл приходит в Telegram после подтверждения оплаты.'
  },
  {
